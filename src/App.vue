...
<template>
  <main class="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
    ...
    <div v-else class="app-shell grid min-h-screen lg:grid-cols-[18rem_1fr]">
      <div
        v-if="isSidebarOpen"
      ...
      <AppSidebar
        class="sidebar-shell z-50 transition-transform lg:relative lg:translate-x-0"
        :class="isSidebarOpen ? 'fixed inset-y-0 left-0 w-72 translate-x-0' : 'fixed inset-y-0 left-0 w-72 -translate-x-full lg:translate-x-0'"
        :spaces="spaces"
        :lists="lists"
      ...
      <section class="app-main-bg min-w-0">
