    ...
    <form class="task-editor-modal" @submit.prevent="handleSubmit">
      ...
      <div class="task-editor-body">
        ...
        <section class="task-editor-section">
          ...
          <div class="task-editor-grid sm:grid-cols-3">
            <div class="task-editor-field">
              <label class="task-editor-label" for="edit-due">Due date</label>
              <input id="edit-due" v-model="form.due_date" class="task-editor-input task-editor-input--datetime" type="datetime-local" />
            </div>
            <div class="task-editor-field">
              <label class="task-editor-label" for="edit-reminder">Reminder</label>
              <input id="edit-reminder" v-model="form.reminder_at" class="task-editor-input task-editor-input--datetime" type="datetime-local" />
            </div>
            <div class="task-editor-field">
